...
class AudioIO:
    ...
    def audioRead(fileName, mono=False):
        ...
        if fileName[convDict['mp3'][1]:] == 'mp3':
            ...
            subprocess.call(convDict['mp3'][0] + modfileName, shell=True, stdout=AudioIO.FNULL,
            ...
            subprocess.call(convDict['wma'][0] + modfileName, shell=True, stdout=AudioIO.FNULL,
                            stderr=subprocess.STDOUT)
            samples, sampleRate = AudioIO.wavRead(modfileName, mono)
            os.remove(modfileName)
            ...
            subprocess.call(convDict['aiff'][0] + modfileName, shell=True, stdout=AudioIO.FNULL,
                            stderr=subprocess.STDOUT)
            samples, sampleRate = AudioIO.wavRead(modfileName, mono)
            os.remove(modfileName)
